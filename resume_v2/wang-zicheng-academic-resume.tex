...
\begin{minipage}[t]{0.76\linewidth}
  \begin{tabularx}{\linewidth}{@{}L{2.55cm}Y@{}}
    ...
    \begin{minipage}[t]{\linewidth}
      ...
      \vspace{-0.08em}
      {\sffamily\bfseries\fontsize{10.5pt}{12.6pt}\selectfont\color{textgray} 电网防灾减灾全国重点实验室}
    \end{minipage}
  \end{tabularx}\par
  \vspace{0.08em}
...
\metriccell{电工杯国一/\allowbreak 国二}{连续两届获国家奖} &
\metriccell{软著 4 项}{全部已授权}
\end{tabularx}

\sectiontitle{综合能力}
\begin{tabularx}{\linewidth}{L{2.25cm}Y}
\textbf{专业方向} & 研究兴趣为高比例新能源电力系统建模、控制与分析，以及 AI 在电力系统中的运用；已有 PMSG 频域建模、阻抗/导纳预测与等效电路降阶研究经历。\\
...
\textbf{综合表现} & 电工杯全国大学生电工数学建模竞赛连续两届获国家奖（2025 年国家一等奖、2026 年国家二等奖，均为队长），并获 2026 年第五届全国大学生数据统计与分析竞赛二等奖（队员）；同时作为长沙智碳联算科技有限责任公司股东（持股 50\%），参与软件开发与业务协调。\\
\end{tabularx}
...
\textbf{学科竞赛} & 2026.08 | 第七届“华数杯”大学生数学建模竞赛 & 国家一等奖（队员）\\
