...
\begin{minipage}[t]{0.76\linewidth}
  ...
  \vspace{0.25em}
  {\sffamily\color{textgray}山东大学夏令营申请材料 \quad 专业方向：新能源设备建模与电力系统稳定性分析 \quad AI+电力系统}\par
  \vspace{0.45em}
...
\sectiontitle{个人陈述}
本人在本科阶段持续围绕专业基础、科研训练与综合能力提升展开学习，兼具应用统计学数理训练和电气工程专业背景。目前主要关注新能源设备频域建模、电力系统稳定性分析、阻抗/导纳预测及 AI+电力系统等方向，已以第一作者完成 SCI 三区期刊论文和 IEEE 会议论文各 1 篇。若有机会参加山东大学夏令营，我希望通过课程学习、学术交流与导师沟通，进一步理解新能源并网稳定性和电力系统智能分析方向的前沿问题，将已有科研训练与研究生阶段规划更好衔接，继续提升理论分析、科研创新和工程实践能力。
